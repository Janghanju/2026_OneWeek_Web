...
import { Check, Cpu, Wifi, Box, Globe, Smartphone, Zap, Cloud, Code } from "lucide-react";
...
export default function ServicesPage() {
    ...
    const services = [
        {
            icon: <Cpu size={40} color="#22c55e" />,
            title: t('embeddedTitle'),
            desc: t('embeddedDesc'),
            color: '#22c55e',
            features: [t('embeddedFeature1'), t('embeddedFeature2'), t('embeddedFeature3')]
        },
        {
            icon: <Wifi size={40} color="#06b6d4" />,
            title: t('iotTitle'),
            desc: t('iotDesc'),
            color: '#06b6d4',
            features: [t('iotFeature1'), t('iotFeature2'), t('iotFeature3')]
        },
        {
            icon: <Box size={40} color="#f59e0b" />,
            title: t('printTitle'),
            desc: t('printDesc'),
            color: '#f59e0b',
            features: [t('printFeature1'), t('printFeature2'), t('printFeature3')]
        },
        {
            ...
            desc: t('webDevDesc'),
            color: 'var(--primary)',
            features: [t('webDevFeature1'), t('webDevFeature2'), t('webDevFeature3')]
        },
        {
            ...
            desc: t('appDevDesc'),
            color: 'var(--accent)',
            features: [t('appDevFeature1'), t('appDevFeature2'), t('appDevFeature3')]
        },
        {
            ...
            color: '#fbbf24',
            features: [t('consultingFeature1'), t('consultingFeature2'), t('consultingFeature3')]
        },
        {
            ...
            desc: t('cloudDesc'),
            color: '#8b5cf6',
            features: [t('cloudFeature1'), t('cloudFeature2'), t('cloudFeature3')]
        },
        {
            ...
            desc: t('apiDesc'),
            color: '#10b981',
            features: [t('apiFeature1'), t('apiFeature2'), t('apiFeature3')]
        }
    ];
